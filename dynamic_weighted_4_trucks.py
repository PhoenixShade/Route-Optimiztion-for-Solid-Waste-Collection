...
visitedNodes = set()
obj_value1 = dyn_multi_opt(data1, [visit1, visit2, visit3, visit4], visitedNodes = visitedNodes, distances = distance, ward_name = 'Truck 1', t_name = 'truck1', folder_Path = 'Data/Dynamic Data/Multiple Trucks/4 Trucks/', w1 = W1, w2 = W2, n_done = [0] * N_TRUCKS, n_trucks = N_TRUCKS)
print('\n Ward 1 Done \n')
...
visitedNodes = set()
obj_value2 = dyn_multi_opt(data2, [visit1, visit2, visit3, visit4], visitedNodes = visitedNodes, distances = distance, ward_name = 'Truck 2', t_name = 'truck2', folder_Path = 'Data/Dynamic Data/Multiple Trucks/4 Trucks/', w1 = W1, w2 = W2, n_done = [0] * N_TRUCKS, n_trucks = N_TRUCKS)
print('\n Ward 2 Done \n')
...
visitedNodes = set()
obj_value3 = dyn_multi_opt(data3, [visit1, visit2, visit3, visit4], visitedNodes = visitedNodes, distances = distance, ward_name = 'Truck 3', t_name = 'truck3', folder_Path = 'Data/Dynamic Data/Multiple Trucks/4 Trucks/', w1 = W1, w2 = W2, n_done = [0] * N_TRUCKS, n_trucks = N_TRUCKS)
print('\n Ward 3 Done \n')
...
v11 = pd.read_csv(f'Data/Dynamic Data/Multiple Trucks/4 Trucks/Visited Truck 1/visited_truck1_1_{W1}_{W2}.csv')
v12 = pd.read_csv(f'Data/Dynamic Data/Multiple Trucks/4 Trucks/Visited Truck 1/visited_truck1_2_{W1}_{W2}.csv')
v13 = pd.read_csv(f'Data/Dynamic Data/Multiple Trucks/4 Trucks/Visited Truck 1/visited_truck1_3_{W1}_{W2}.csv')
v14 = pd.read_csv(f'Data/Dynamic Data/Multiple Trucks/4 Trucks/Visited Truck 1/visited_truck1_4_{W1}_{W2}.csv')

v21 = pd.read_csv(f'Data/Dynamic Data/Multiple Trucks/4 Trucks/Visited Truck 2/visited_truck2_1_{W1}_{W2}.csv')
v22 = pd.read_csv(f'Data/Dynamic Data/Multiple Trucks/4 Trucks/Visited Truck 2/visited_truck2_2_{W1}_{W2}.csv')
v23 = pd.read_csv(f'Data/Dynamic Data/Multiple Trucks/4 Trucks/Visited Truck 2/visited_truck2_3_{W1}_{W2}.csv')
v24 = pd.read_csv(f'Data/Dynamic Data/Multiple Trucks/4 Trucks/Visited Truck 2/visited_truck2_4_{W1}_{W2}.csv')

v31 = pd.read_csv(f'Data/Dynamic Data/Multiple Trucks/4 Trucks/Visited Truck 3/visited_truck3_1_{W1}_{W2}.csv')
v32 = pd.read_csv(f'Data/Dynamic Data/Multiple Trucks/4 Trucks/Visited Truck 3/visited_truck3_2_{W1}_{W2}.csv')
v33 = pd.read_csv(f'Data/Dynamic Data/Multiple Trucks/4 Trucks/Visited Truck 3/visited_truck3_3_{W1}_{W2}.csv')
v34 = pd.read_csv(f'Data/Dynamic Data/Multiple Trucks/4 Trucks/Visited Truck 3/visited_truck3_4_{W1}_{W2}.csv')
...
stats = pd.DataFrame(
    ...
    }, index=['Truck 1', 'Truck 2', 'Truck 3', 'Truck 4', 'Total Percentage'])
